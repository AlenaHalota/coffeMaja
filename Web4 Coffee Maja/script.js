...
//THE ABOVE IS OPTIMIZED BELOW BY CREATE A FUNCTION CONSRUCTION
...
UI.prototype.addCustomer = function (customer) {
	...
	div.innerHTML = `<img src="woman.jpeg" alt="person" class="person__thumbnail">
...
UI.prototype.showModal = function(event) {
	...
	if(event.target.parentElement.classList.contains('work-item__icon'));
		...
		modalItem.style.backgroundImage = `url(coffee${id}.jpeg)`
}
